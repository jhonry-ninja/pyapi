...
def main():
    ...
    for cred in credz:
        ...
        sftpsession.close()
        sshsession.close()
        """Add general exception handling to one of the scripts. On an error, always attempt to close the connection and print out an message indicating some kind of connection error occurred."""
        while True:
            try:
